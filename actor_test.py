...
xy_data = train_datagen.flow_from_directory(
    'd:/study_data/_data/test_image/actor/',
    target_size=(150, 150),
    batch_size=5000, 
...
test = train_datagen.flow_from_directory(
     'd:/study_data/_data/test_image/tpic/',
     target_size=(150,150)
)
...
#수치화한 데이터를 저장한다.
np.save('d:/study_data/_save/_npy/actor_train_x.npy', arr=x_train) # train x값
np.save('d:/study_data/_save/_npy/actor_train_y.npy', arr=y_train) # train y값
np.save('d:/study_data/_save/_npy/actor_test_x.npy', arr=x_test) # test x값
np.save('d:/study_data/_save/_npy/actor_test_y.npy', arr=y_test) # test y값
np.save('d:/study_data/_save/_npy/actor_test.npy', arr=test) # test y값
