...
x_train = np.load('d:/study_data/_save/_npy/actor_train_x.npy')
y_train = np.load('d:/study_data/_save/_npy/actor_train_y.npy')
x_test = np.load('d:/study_data/_save/_npy/actor_test_x.npy')
y_test = np.load('d:/study_data/_save/_npy/actor_test_y.npy')
test = np.load('d:/study_data/_save/_npy/actor_test.npy')
